...
class robot:
    ...
    def sense(self):
        ...
        #    dx = abs(j[0] - self.x) + self.rand() * self.measurement_noise
        #    dy = abs(j[1] - self.y) + self.rand() * self.measurement_noise
            #print("X,Y is", dx, dy)
            #print("Measurement range", self.measurement_range )
           # if cur_range > self.measurement_range:
            #print("Types i,x,y,measurements:", type(i), type(dx), type(dy), type(measurements))
